...
public class StageData
{
    ...
    {
        return $"{Stage} / {StageName} / {SpawnNum} / {M1Id} / {M1Num} / {M2Id} / {M2Num} / {M3Id} / {M3Num} / {MiniBossID} / {MiniBossNum} / {WaveTime} / {StageAddMHp} / {StageAddMAtt} / {ClearGoldMin} / {ClearGoldMax} / {FailGoldMin} / {FailGoldMax}";
    }
}
